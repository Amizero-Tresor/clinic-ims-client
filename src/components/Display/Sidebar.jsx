...
const Sidebar = ({ isOpen, toggleSidebar }) => {
  ...
  return (
    <div
      className={`fixed z-50 bg-blue text-white w-[250px] rounded-lg h-full p-4 transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out md:static md:translate-x-0 md:h-[80%] md:ml-3 md:mt-5 md:flex md:flex-col md:items-center md:shadow-xl lg:hidden`}
    >
